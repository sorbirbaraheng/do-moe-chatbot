...
const DataManagementTab: React.FC<DataManagementTabProps> = () => {
    return (
        <div className="space-y-6">
            <div className="bg-white p-6 rounded-2xl border border-black/5 border-dashed">
                <div className="flex flex-col items-center justify-center py-8">
                    ...
                    <p className="text-black/60 font-medium mb-4">ลากไฟล์มาวางที่นี่ หรือ</p>
                    <button className="px-6 py-2.5 bg-blue-600 text-white rounded-xl text-sm font-bold hover:bg-blue-700 transition-all">
                        เลือกไฟล์
                    </button>
                    <p className="text-xs text-black/40 mt-3">รองรับ: CSV, JSON, PDF, TXT</p>
                </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button className="bg-white p-6 rounded-2xl border border-black/5 hover:shadow-lg transition-all text-left group">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="font-bold text-[#1D1D1F]">Trigger Re-index</span>
                    </div>
                ...
                <button className="bg-white p-6 rounded-2xl border border-black/5 hover:shadow-lg transition-all text-left group">
                    ...
                    <p className="text-sm text-black/50">ตรวจคุณภาพ embeddings</p>
                </button>
            </div>
        </div>
    );
