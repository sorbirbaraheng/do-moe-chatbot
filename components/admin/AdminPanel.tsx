...
type TabId = 'api' | 'prompts' | 'model' | 'rag' | 'data' | 'ux' | 'monitor' | 'analytics';
...
const AdminPanel: React.FC<AdminPanelProps> = ({ onClose }) => {
    ...
    const [activeApiCategory, setActiveApiCategory] = useState<'general' | 'school' | 'student'>('general');
        ...
        switch (activeTab) {
            ...
            case 'model':
                return (
                    <ModelConfigTab
                        {...sharedProps}
                        supportedModelsByCategory={supportedModelsByCategory}
                    />
                );

            case 'rag':
                return <RagConfigTab {...sharedProps} updateRAG={updateRAG} />;

            case 'data':
                return <DataManagementTab {...sharedProps} />;

            case 'ux':
                return <UxPolicyTab {...sharedProps} />;
